...
function elevar(num, exponent) {
  ...
  // Tu código:
  let elevarAlExponente = Math.pow(num,exponent); 
...
function redondearNumero(num) {
  ...
  // Tu código:
  let redondearAlEntero = Math.round(num);
  return redondearAlEntero; 
}
...
function numeroRandom() {
  ...
  let random = Math.random(); // genera un numero al azar entre 0 y 1
  return random; 
}
...
function agregarSimboloExclamacion(str) {
  ...
  // Tu código:
  let agregarSignoExclamacion = str + "!";
  return agregarSignoExclamacion; 
}
...
function combinarNombres(nombre, apellido) {
  ...
  // Tu código:
 let agregarEspacio = nombre + " " + apellido;  
